...
public class PreferenceBuilder {
    ...
    public static com.mercadopago.resources.Preference buildPreference(Preference preference, Item item, User consumer) throws MPException {
        return new com.mercadopago.resources.Preference().appendItem(ItemBuilder.buildItem(item, preference.getQuantity()))
                ...
                .setShipments(ShipmentBuilder.buildShipment(consumer.getAddress(), item))
